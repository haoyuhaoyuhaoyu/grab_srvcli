...
///  RM_APISHARED_EXPORT
///
RM_BASESHARED_EXPORT int RM_API_Init(RM_Callback pCallback);
...
/// \param arm_ip                   IP地址
/// \param arm_port                 端口号
/// \param dev_mode                 目标设备型号65/75/63
/// \param recv_timeout             Socket连接超时时间
/// \return                         成功返回：Socket 句柄。失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT SOCKHANDLE Arm_Socket_Start(char* arm_ip,int arm_port, int devMode, int recv_timeout);
...
///
RM_BASESHARED_EXPORT int Arm_Sockrt_State(SOCKHANDLE ArmSocket);
...
/// \return 0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Set_DH_Data(SOCKHANDLE ArmSocket, float lsb, float lse, float lew, float lwt, float d3, bool block);
...
/// \return 0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Get_DH_Data(SOCKHANDLE ArmSocket, float* lsb, float* lse, float* lew, float* lwt, float* d3);
...
/// \return 0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Get_All_Tool_Frame(SOCKHANDLE ArmSocket, FRAME_NAME *names);
...
/// \return 0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Get_All_Work_Frame(SOCKHANDLE ArmSocket, FRAME_NAME *names);
...
/// \return                     0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Set_Install_Pose(SOCKHANDLE ArmSocket, float x,float y,bool block);
...
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Set_Force_Postion(SOCKHANDLE ArmSocket, int mode,int force_level,bool block);
...
/// \return 0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Set_Force_Sensor(SOCKHANDLE ArmSocket, bool block);
...
/// \return 0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Set_PWM(SOCKHANDLE ArmSocket, int Frq, int Dpulse, bool block);
...
/// \return 0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Auto_Set_Fz(SOCKHANDLE ArmSocket, bool block);
...
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Set_Lift(SOCKHANDLE ArmSocket, int height,int speed,bool block);
...
/// \return                         0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Set_Lift_Speed(SOCKHANDLE ArmSocket, int speed,bool block);
...
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Force_Position_Move_POSE(SOCKHANDLE ArmSocket, POSE pose,byte sensor,byte mode,int dir,float force,bool block);
RM_BASESHARED_EXPORT int Force_Position_Move_Joint(SOCKHANDLE ArmSocket, const float *joint,byte sensor,byte mode,int dir,float force,bool block);
...
/// \return
///
RM_BASESHARED_EXPORT KINEMATIC Forward_Kinematics(int dev_mode, const float * joint);
...
///
RM_BASESHARED_EXPORT int inverse_kinematics(int dev_mode, const float *q_in, const KINEMATIC *q_pose, float *q_out,const uint8_t flag);
...
/// \param choose_axis
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
RM_BASESHARED_EXPORT Pose RotateMove(int dev_mode, float *Joint_Cur,int rotateAxis, float rotateAngle, Pose co_tool, Pose co_work, Pose choose_axis);
...
///
RM_BASESHARED_EXPORT Pose Base_To_WorkFrame(Pose state, Matrix matrix);

///
/// \brief Base_To_WorkFrame      工作坐标系转基座标系
/// \param state                  工具端坐标在工作座标系下位姿
/// \param matrix                 工作坐标系在基座标系下的矩阵
/// \return                       工作坐标系下的位姿
///
RM_BASESHARED_EXPORT Pose WorkFrame_To_Base(Pose state, Matrix matrix);
